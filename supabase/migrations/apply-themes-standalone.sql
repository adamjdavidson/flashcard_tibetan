-- Standalone Themes Migration
-- This can be run directly in Supabase SQL Editor if migrations conflict
-- It creates the themes system independently
...
DROP POLICY IF EXISTS "Users can manage own preferences" ON user_theme_preferences;
